...
```
##una data que se llama regiones que tiene esclusivamente las variables numericas con las que calcularemos los clusters
##se creea una misma copia de regiones que se llama subdata y se le saca los NA perdidos. se crea esta copia para solo copiar eñ codigo y acelerar en tiempo
########################################################################################
...
respuesta: ¿con cuantos te quedas? 3 dependiendo de la linea que salga. en los dos graficos es el mismo
...
Primero calculamos cada uno de los cluster según las tres metodologías aprendidas hasta el momento. Ojo con el "cluster.only = F"". #genera una lista de elementos.
...
Respuesta: NOS QUEDAMOS CON EL 0.52 que es de particion
...
##los negativos son los mal clasificados
