...
RESPUESTA: 
- el total de clusters es 153 por la tabla de dbscan
-Analizando la grafica, los casos que no se pueden clusterizar con 3 (Uzbekistan, Rwanda y Solmalia). Asimismo, analizando la tabla de dbscan son tresgrupos que no fueron clasificados porque estan en la columna 0.
